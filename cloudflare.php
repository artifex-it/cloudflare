...
Version: 1.3.18-art
Author: Ian Pye, Jerome Chen, James Greene, Simon Moore, David Fritsch (CloudFlare Team), Paolo Betti
License: GPLv2
*/
...
function cloudflare_init() {
    ...
    if (isset($_SERVER["REMOTE_ADDR"])) {
		if (strpos($_SERVER["REMOTE_ADDR"], ":") === FALSE) {
			...
			$cf_ip_ranges = array("199.27.128.0/21","173.245.48.0/20","103.21.244.0/22","103.22.200.0/22","103.31.4.0/22","141.101.64.0/18","108.162.192.0/18","190.93.240.0/20","188.114.96.0/20","197.234.240.0/22","198.41.128.0/17","162.158.0.0/15","104.16.0.0/13","104.24.0.0/14","172.64.0.0/13");
            $ipv4 = ($_SERVER["HTTP_X_CLIENT_IP"] ? $_SERVER["HTTP_X_CLIENT_IP"] : $_SERVER["REMOTE_ADDR"]);
			// IPV4: Update the REMOTE_ADDR value if the current REMOTE_ADDR value is in the specified range.
			foreach ($cf_ip_ranges as $range) {
				if (ipv4_in_range($ipv4, $range)) {
